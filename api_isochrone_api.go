...
type IsochroneAPIApiService service

type ApiGetIsochroneRequest struct {
	ctx _context.Context
	ApiService *IsochroneAPIApiService
	point *string
	timeLimit *int32
	distanceLimit *int32
...
func (r ApiGetIsochroneRequest) Vehicle(vehicle VehicleProfileId) ApiGetIsochroneRequest {
	r.vehicle = &vehicle
	return r
}
...
func (r ApiGetIsochroneRequest) Weighting(weighting string) ApiGetIsochroneRequest {
	r.weighting = &weighting
	return r
}

func (r ApiGetIsochroneRequest) Execute() (IsochroneResponse, *_nethttp.Response, error) {
 ...
 */
func (a *IsochroneAPIApiService) GetIsochrone(ctx _context.Context) ApiGetIsochroneRequest {
	return ApiGetIsochroneRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *IsochroneAPIApiService) GetIsochroneExecute(r ApiGetIsochroneRequest) (IsochroneResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IsochroneAPIApiService.GetIsochrone")
	if err != nil {
	...
	if r.timeLimit != nil {
		localVarQueryParams.Add("time_limit", parameterToString(*r.timeLimit, ""))
	}
	if r.distanceLimit != nil {
		localVarQueryParams.Add("distance_limit", parameterToString(*r.distanceLimit, ""))
	}
	if r.vehicle != nil {
		localVarQueryParams.Add("vehicle", parameterToString(*r.vehicle, ""))
	}
	if r.buckets != nil {
		localVarQueryParams.Add("buckets", parameterToString(*r.buckets, ""))
	}
	if r.reverseFlow != nil {
		localVarQueryParams.Add("reverse_flow", parameterToString(*r.reverseFlow, ""))
	}
	if r.weighting != nil {
