...
type MapMatchingAPIApiService service

type ApiPostGPXRequest struct {
	ctx _context.Context
	ApiService *MapMatchingAPIApiService
	gpsAccuracy *int32
	vehicle *string
}
...
func (r ApiPostGPXRequest) Vehicle(vehicle string) ApiPostGPXRequest {
	r.vehicle = &vehicle
	return r
}

func (r ApiPostGPXRequest) Execute() (RouteResponse, *_nethttp.Response, error) {
 ...
 */
func (a *MapMatchingAPIApiService) PostGPX(ctx _context.Context) ApiPostGPXRequest {
	return ApiPostGPXRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *MapMatchingAPIApiService) PostGPXExecute(r ApiPostGPXRequest) (RouteResponse, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MapMatchingAPIApiService.PostGPX")
	if err != nil {
	...
	if r.gpsAccuracy != nil {
		localVarQueryParams.Add("gps_accuracy", parameterToString(*r.gpsAccuracy, ""))
	}
	if r.vehicle != nil {
