...
type RouteOptimizationAPIApiService service

type ApiAsyncVRPRequest struct {
	ctx _context.Context
	ApiService *RouteOptimizationAPIApiService
	request *Request
}
...
func (r ApiAsyncVRPRequest) Execute() (JobId, *_nethttp.Response, error) {
 ...
 */
func (a *RouteOptimizationAPIApiService) AsyncVRP(ctx _context.Context) ApiAsyncVRPRequest {
	return ApiAsyncVRPRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return JobId
 */
func (a *RouteOptimizationAPIApiService) AsyncVRPExecute(r ApiAsyncVRPRequest) (JobId, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RouteOptimizationAPIApiService.AsyncVRP")
	if err != nil {
...
func (r ApiGetSolutionRequest) Execute() (Response, *_nethttp.Response, error) {
 ...
 */
func (a *RouteOptimizationAPIApiService) GetSolution(ctx _context.Context, jobId string) ApiGetSolutionRequest {
	return ApiGetSolutionRequest{
		ApiService: a,
		ctx: ctx,
		jobId: jobId,
 ...
 * @return Response
 */
func (a *RouteOptimizationAPIApiService) GetSolutionExecute(r ApiGetSolutionRequest) (Response, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RouteOptimizationAPIApiService.GetSolution")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiSolveVRPRequest) Execute() (Response, *_nethttp.Response, error) {
 ...
 */
func (a *RouteOptimizationAPIApiService) SolveVRP(ctx _context.Context) ApiSolveVRPRequest {
	return ApiSolveVRPRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return Response
 */
func (a *RouteOptimizationAPIApiService) SolveVRPExecute(r ApiSolveVRPRequest) (Response, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "RouteOptimizationAPIApiService.SolveVRP")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
